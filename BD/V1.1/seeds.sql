...
INSERT INTO equipo (id, nombre, tipo, lider_id) VALUES
    ...
    (
        -- v1.2: equipo para usuarios del portal de clínicas
        -- Todos los usuarios con rol CLINICA pertenecen a este equipo
...
--   COMMIT;
--
-- Para crear un usuario de clínica (v1.2):
--   INSERT INTO usuario (nombre, apellido, email, username, password_hash,
--                        rol, equipo_id, clinica_id)
--   VALUES ('Recepción', 'Dental Smile', 'recepcion@dentalsmile.com',
--           'dental_smile', '<bcrypt_hash>', 'CLINICA',
--           '00000000-0000-0000-0002-000000000004',   -- equipo Portal Clínicas
--           '<uuid de la clínica en tabla clinica>');
--
